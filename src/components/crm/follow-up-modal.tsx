...
export function FollowUpModal({ open, onOpenChange, leadName }: FollowUpModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!followUpData.leadId || !followUpData.tipo || !followUpData.dataAgendada) {
      toast({
    ...
    try {
      ...
      const dataFormatada = new Date(followUpData.dataAgendada).toLocaleDateString('pt-BR');
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Agende um contato de follow-up com um lead para manter o relacionamento ativo.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 space-y-2">
              ...
              <Select value={followUpData.leadId} onValueChange={(value) => handleInputChange("leadId", value)}>
                <SelectTrigger>
            ...
            <div className="col-span-2 space-y-2">
              ...
              <Select value={followUpData.tipo} onValueChange={(value) => handleInputChange("tipo", value)}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select value={followUpData.prioridade} onValueChange={(value) => handleInputChange("prioridade", value)}>
                <SelectTrigger>
