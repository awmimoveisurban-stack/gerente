...
export function LeadCard({ lead, onViewDetails, onCall, onEmail, onScheduleVisit }: LeadCardProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
      ...
      <CardContent className="p-3 space-y-2">
        ...
        {lead.valor_interesse && (
          <div className="flex justify-center">
            <Badge variant="outline" className="font-mono bg-green-50 dark:bg-green-950/20 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800 px-2 py-0.5 text-xs">
