...
export default function Login() {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        navigate("/gerente");
          ...
          toast({
            title: "Login realizado com sucesso!",
            description: "Bem-vindo, Corretor!",
          });
      } else {
          navigate("/auth");
          toast({
            title: "Acesso não autorizado",
            description: "Seu usuário não possui permissões válidas.",
            variant: "destructive"
          });
        }
      }, 500);
  ...
  }, [formData, signIn, navigate, toast, hasRole]);
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                  Apenas usuários autorizados podem acessar o sistema. Contate seu gerente para obter credenciais.
                </p>
              </div>
            </div>
          </CardContent>
