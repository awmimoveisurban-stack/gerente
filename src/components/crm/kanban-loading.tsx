    ...
    <div className='space-y-6 animate-pulse'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6'>
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className='bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/30 dark:to-gray-900/30 p-6 rounded-2xl border border-gray-200/50 dark:border-gray-700/50'
          >
        ...
        <CardContent className='p-6'>
          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4'>
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className='p-4 rounded-xl border border-gray-200/50 dark:border-gray-700/50'
              >
          ...
          >
            ...
            <CardContent className='p-4 space-y-3'>
              {[...Array(3)].map((_, j) => (
                <div
                  key={j}
                  className='p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50'
                >
                  <div className='space-y-2'>
