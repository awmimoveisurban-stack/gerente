  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const dataVencimento = taskData.horaVencimento 
        ? new Date(`${taskData.dataVencimento}T${taskData.horaVencimento}`).toISOString()
      ...
      await createTask({
        ...
        lead_id: taskData.leadRelacionado !== "none" ? taskData.leadRelacionado : undefined,
      });
      
      const dataFormatada = new Date(taskData.dataVencimento).toLocaleDateString('pt-BR');
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Crie uma nova tarefa para organizar sua agenda e acompanhar atividades.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("horaVencimento", e.target.value)}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={taskData.prioridade} onValueChange={(value) => handleInputChange("prioridade", value)}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select value={taskData.categoria} onValueChange={(value) => handleInputChange("categoria", value)}>
                <SelectTrigger>
            ...
            <div className="col-span-2 space-y-2">
              ...
              <Select value={taskData.leadRelacionado} onValueChange={(value) => handleInputChange("leadRelacionado", value)}>
                <SelectTrigger>
