              ...
              <div className="space-y-2">
                ...
                <Select value={callResult} onValueChange={setCallResult}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="numero-incorreto">Número incorreto</SelectItem>
                    <SelectItem value="interessado">Interessado - Agendar reunião</SelectItem>
                    <SelectItem value="nao-interessado">Não interessado</SelectItem>
                  </SelectContent>
                </Select>
              </div>
