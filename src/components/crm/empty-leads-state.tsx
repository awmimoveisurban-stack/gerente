...
import { Users, Plus, Search, Filter, FileText, Lightbulb } from 'lucide-react';
      ...
      <Card className='bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg'>
        <CardContent className='p-12 text-center'>
          ...
          <p className='text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto'>
            Não encontramos leads que correspondam aos filtros aplicados. Tente
            ajustar os critérios de busca ou limpar os filtros.
          </p>
  ...
  return (
    <Card className='bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg'>
      <CardContent className='p-12 text-center'>
        ...
        <p className='text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto'>
          Comece adicionando seu primeiro lead para acompanhar oportunidades de
          venda e gerenciar seu pipeline de negócios.
        </p>
        <div className='flex flex-col sm:flex-row gap-3 justify-center'>
          <Button
            onClick={onAddLead}
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-600 dark:text-blue-300'>
                  Capture informações de contato e interesse
                </p>
              </div>
            </div>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-600 dark:text-blue-300'>
                  Monitore o progresso de cada oportunidade
                </p>
              </div>
            </div>
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-600 dark:text-blue-300'>
                  Converta leads em clientes satisfeitos
                </p>
              </div>
            </div>
          </div>
