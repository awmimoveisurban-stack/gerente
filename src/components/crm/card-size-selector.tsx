...
import { LayoutGrid, Square, Minimize2, Settings } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export const CardSizeSelector = memo(function CardSizeSelector({
  ...
  const getDescription = (size: string) => {
    switch (size) {
      case 'default':
        return 'Cards com informações completas';
      case 'compact':
        return 'Cards otimizados para melhor visualização';
      case 'mini':
        return 'Cards ultra-compactos para máxima densidade';
      default:
        return 'Cards com informações completas';
    }
  };
