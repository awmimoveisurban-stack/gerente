...
export function FunnelVisualization({ leads }: FunnelVisualizationProps) {
  ...
  const conversionRate =
    totalLeads > 0 ? (funnelData[5].count / totalLeads) * 100 : 0;
              ...
              <div key={stage.stage} className='relative'>
                ...
                <div className='flex items-center gap-4 p-4 bg-muted/30 rounded-lg'>
                  ...
                  <div className='flex items-center gap-3 min-w-0 flex-1'>
                    <div
                      className={`p-2 rounded-full ${stage.color} text-white`}
                    >
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-blue-700 dark:text-blue-300 mt-1'>
                    A etapa "Contatados" tem apenas {funnelData[1].count} leads
                    ({funnelData[1].percentage.toFixed(1)}%). Considere aumentar
                    o número de contatos iniciais.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-green-700 dark:text-green-300 mt-1'>
                    A conversão de "Interessados" para "Visita Agendada" está em{' '}
                    {funnelData[3].percentage.toFixed(1)}%, acima da média do
                    mercado (25%).
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-yellow-700 dark:text-yellow-300 mt-1'>
                    A taxa de conversão final está em{' '}
                    {conversionRate.toFixed(1)}%. Foque em melhorar a qualidade
                    dos leads e o processo de follow-up.
                  </p>
                </div>
              </div>
            </div>
